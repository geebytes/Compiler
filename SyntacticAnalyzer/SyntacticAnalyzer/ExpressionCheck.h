...
#ifndef EXPRESSIONCHECK_H __declspec(dllexport)
#define EXPRESSIONCHECK_H __declspec(dllexport)
...
///=================================================================================================
/// \enum EXPRESSIONCHECK_H
///
/// \brief 表达式错误代码.
///=================================================================================================

enum EXPRESSIONCHECK_H ERROR_CODE {
...
class EXPRESSIONCHECK_H ExpressionCheck {
  public:
    ExpressionCheck();
