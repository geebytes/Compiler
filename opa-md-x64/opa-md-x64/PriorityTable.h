...
///
/// \brief Declares the priority table class.
///=================================================================================================

#ifndef PRIORITYTABLE_H __declspec(dllexport)
#define PRIORITYTABLE_H __declspec(dllexport)
#include <stack>
#include<vector>
#include <string>
#include <set>
...
class PRIORITYTABLE_H PriorityTable {
  public:
    PriorityTable();
    //获取产生式
